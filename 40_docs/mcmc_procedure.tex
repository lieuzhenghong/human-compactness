...
approach is a stochastic process that generates plans by performing
something like a random walk over plausible districting plans. I chose
this approach because it generates the largest and most representative
subset of plans while making the least assumptions about what makes a
district ``good''. Additionally, my chosen approach is regarded as the
state-of-the-art in the computational redistricting literature
\citep{ddj2019recom}.
...
\subsubsection{The best and worst plans according to different
compactness
...
\hypertarget{how-district-homogeneity-varies-within-districts-and-states-really-needs-work}{%
\subsubsection{How district homogeneity varies within districts and
states (really needs
work!)}\label{how-district-homogeneity-varies-within-districts-and-states-really-needs-work}}
...
\subsubsection{Districts that are small and urban are usually more
spatially
...
\hypertarget{comparing-different-compactness-measures}{%
\subsection{Comparing different compactness
measures}\label{comparing-different-compactness-measures}}
...
\hypertarget{only-under-human-compactness-are-top-plans-more-homogeneous-than-average}{%
\subsubsection{Only under human compactness are top plans more
homogeneous than
average}\label{only-under-human-compactness-are-top-plans-more-homogeneous-than-average}}
...
It was certainly the right call to use many different compactness
